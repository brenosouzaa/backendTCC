...
import br.itb.projeto.techzoom.model.service.ProdutoService;
...
public class ProdutoController {
	...
	public String verProdutosPorNome(ModelMap model, @RequestParam(value = "nome", required = false) String nome) {
	...
	@PostMapping("/salvar")
	public String salvar(@RequestParam(value = "file", required = false) MultipartFile file, Produto produto, ModelMap model) {
	...
	public String editar(@RequestParam(value = "file", required = false) MultipartFile file,
	...
	@ResponseBody
	public void showImage(@PathVariable("id") long id, HttpServletResponse response, Produto produto)
